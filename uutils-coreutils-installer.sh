...
# Remember to install the empty .deb/.rpm coreutils metapackage with your designated package manager and then versionlock coreutils.
...
for i in $commandsuu; do
	...
	coreutils rm -f /bin/$i
	coreutils ln -s /bin/coreutils /bin/$i
done
